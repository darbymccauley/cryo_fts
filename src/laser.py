...
class TopticaController: 
    def __init__(self, ip_address = ''): #fill in with IP address
    ...
    def emission_on(self):
        self.dlc.emission.set(True)
        print("Emission on")

    def emission_off(self):
        self.dlc.emission.set(False)
        print("Emission off")
    
    def set_frequency(self, freq_ghz):
        self.dlc.frequency_set.set(freq_ghz)
    
    def get_frequency(self):
        return self.dlc.frequency_act.get()
